...
public class ApplicationContant {
    public static final String LIST_OF_BOOKS = "1. List of books";
    public static final String CHECKOUT_BOOK = "2. Checkout Book";
    public static final String RETURN_BOOK = "3. Return Book";
    public static final String QUIT = "4. Quit";
